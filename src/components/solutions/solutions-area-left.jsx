...
function SolutionsAreaLeft({ data, color }) {
  return (
    <>
      <style jsx>
        {`
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-6 col-lg-12">
              <div
                className="tp-sv-details-serive-left mr-10 ml-10 wow tpfadeUp"
                data-wow-delay=".3s"
              >
            ...
            <div className="col-xl-6 col-lg-12">
              <div className="tp-sv-details-serive-left wow tpfadeUp ml-md-40">
                <div className="row">
...
export default SolutionsAreaLeft;
