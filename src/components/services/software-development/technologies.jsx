...
import technologyData from "@/src/data/services/software-development/technology-data";
...
function Technologies() {
  return (
    <>
      ...
      <div className="technologies-area theme-bg-black">
            ...
            {technologyData.map((technology, i) => {
              return (
                <div className="singleTech" key={i}>
                  ...
                  >
                    <path
                      d="M21 40L38.5 9.68911H73.5L91 40L73.5 70.3109H38.5L21 40Z"
