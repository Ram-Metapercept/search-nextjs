const softwareEngineeringData = [
  {
    ...
    subTypes: [
      {
        name: "DITAxPresso",
        img: "/assets/img/solutions/software-engineering/lineIcon/logo.png",
      },
      {
        name: "LearnOL",
        img: "/assets/img/solutions/software-engineering/lineIcon/LearnOL.png",
      },
      {
        name: "Web Applications",
        img: "/assets/img/solutions/software-engineering/lineIcon/WebApplications.png",
      },
      {
        name: "Custom Software",
        img: "/assets/img/solutions/software-engineering/lineIcon/CustomSoftware.png",
      },
    ],
    backColor: "#f8fbff",
    tabBackColor: "#eff2fa",
    ...
    subTypesInfo: [
      {
        name: "DITAxPresso",
        img: "/assets/img/solutions/software-engineering/new/logo.png",
      ...
      {
        name: "LearnOL",
        img: "/assets/img/solutions/software-engineering/new/LearnOL.png",
      ...
      {
        name: "Web Applications",
        img: "/assets/img/solutions/software-engineering/new/WebApplications.png",
      ...
      {
        name: "Custom Software",
        img: "/assets/img/solutions/software-engineering/new/CustomSoftware.png",
  ...
  },
  {
    ...
    subTypes: [
      {
        name: "User Interface",
        img: "/assets/img/solutions/software-engineering/lineIcon/graphic.png",
      },
      {
        name: "Business Logic",
        img: "/assets/img/solutions/software-engineering/lineIcon/fuzzy.png",
      },
      {
        name: "API Management",
        img: "/assets/img/solutions/software-engineering/lineIcon/settings.png",
      },
      {
        name: "Database",
        img: "/assets/img/solutions/software-engineering/lineIcon/database.png",
      },
    ],
    backColor: "white",
    // tabBackColor: "#d1e7ff",
    // // tabBackColor: "#f1fef8",
    // tabBackColorDark: "#0079FF",
    ...
    subTypesInfo: [
      {
        name: "User Interface",
        img: "/assets/img/solutions/software-engineering/new/user-interface.png",
      ...
      {
        name: "Business Logic",
        img: "/assets/img/solutions/software-engineering/new/buss-logic.png",
      ...
      {
        name: "API Management",
        img: "/assets/img/solutions/software-engineering/new/api-man.png",
      ...
      {
        name: "Database",
        img: "/assets/img/solutions/software-engineering/new/database.png",
    ...
    subTypes: [
      {
        ...
        img: "/assets/img/solutions/software-engineering/lineIcon/coding.png",
      },
      {
        name: "Platform Evaluation",
        img: "/assets/img/solutions/software-engineering/lineIcon/cross-platform.png",
      },
      {
        name: "Application Deployment",
        img: "/assets/img/solutions/software-engineering/lineIcon/cloud-network.png",
      },
      {
        name: "Service Delivery",
        img: "/assets/img/solutions/software-engineering/lineIcon/product.png",
      },
    ],
    backColor: "#f8fbff",
    // tabBackColor: "#d7eaff",
    // // tabBackColor: "#eff2fa",
    // tabBackColorDark: "#337CCF",
    // // tabBackColorDark: "#324da0",
    tabBackColor: "#eff2fa",
    tabBackColorDark: "#324da0",
    subTypesInfo: [
      {
        name: "Application Development",
        img: "/assets/img/solutions/software-engineering/new/app-dev.png",
      ...
      {
        name: "Platform Evaluation",
        img: "/assets/img/solutions/software-engineering/new/plat-evo.png",
      ...
      {
        name: "Application Deployment",
        img: "/assets/img/solutions/software-engineering/new/app-deploy.png",
      ...
      {
        name: "Service Delivery",
        img: "/assets/img/solutions/software-engineering/new/service-del.png",
  ...
  },
  {
    ...
    subTypes: [
      {
        name: "Configuration",
        img: "/assets/img/solutions/software-engineering/lineIcon/automation.png",
      },
      {
        name: "Collaboration",
        img: "/assets/img/solutions/software-engineering/lineIcon/team-work.png",
      },
      {
        name: "Development",
        img: "/assets/img/solutions/software-engineering/lineIcon/web-development.png",
      },
      {
        name: "Deployment",
        img: "/assets/img/solutions/software-engineering/lineIcon/cloud-service.png",
      },
    ],
    backColor: "white",
    // tabBackColor: "#cbddf8",
    // // tabBackColor: "#fef3eb",
    // tabBackColorDark: "#6499E9",
    ...
    subTypesInfo: [
      {
        name: "Configuration",
        img: "/assets/img/solutions/software-engineering/new/config.png",
      ...
      {
        name: "Collaboration",
        img: "/assets/img/solutions/software-engineering/new/colabaration.png",
      ...
      {
        name: "Development",
        img: "/assets/img/solutions/software-engineering/new/Devops-Development.png",
      ...
      {
        name: "Deployment",
        img: "/assets/img/solutions/software-engineering/new/Devops-Deployment.png",
