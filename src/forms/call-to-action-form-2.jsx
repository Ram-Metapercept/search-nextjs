...
const CallToActionForm = () => {
  ...
  return (
    <>
      ...
      <form
        method="POST"
        action="https://cfed3d59.sibforms.com/serve/MUIFAIJD2TKwT2YjUChcQJVW6CzCqJHToXGAAjWpZeKtweD4uMXS-7uZpHdEfx4dW89ny0ipO7wElAc2UEzDfq7_Yi44gci57T1D55pkIeJIETyOHT6COUvrAIOvLPFKcjhlN20PyzGjOOyy-ONOwTA_4LBrOrvLYBG8E2TIC0RDwNOxDmM92vtI5uDzGhazZXNRSlMKcQp0e0UC"
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="input-item">
              ...
              <select required="required" name="COUNTRY_CODE">
          ...
          <div className="col-12">
            ...
            <button
              type="submit"
              className={`it-cta-form-submit border-0 ${styles.formSubmitBtnHover}`}
              style={{
                boxShadow:
